 ...
 * @author user
 */
public class RegistrationExpenseSelectorRegisterController implements Initializable {
    ...
    private void loadCRScanner(){
        ...
        RegistrationExpenseController loController = new RegistrationExpenseController();
        FXMLLoader fxmlLoader = new FXMLLoader();
        fxmlLoader.setLocation(getClass().getResource("RegistrationExpense.fxml"));
        ...
        loController.setRegistrationExpenseRegister(this);
