...
public class RegistrationExpenseSelectorController implements Initializable {
...
//                    }
    ...
    private void loadCRScanner(){
        ...
        loController.setRegistrationExpense(this);
    ...
    public void loadParameter(int fnValue){
        switch(fnValue){
            case 1:
                ...
                poTrans.setOrigin(poGRider.getBranchCode());
