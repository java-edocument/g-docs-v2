...
public class MultipleDocsScannerController implements Initializable {
    ...
    public void setMultipleDocs(MultipleDocsSelectionController loController){
        this.loCrDocs = loController;
    }
    
    public void setMultipleDocsReg(MultipleDocsSelectionRegisterController loController){
