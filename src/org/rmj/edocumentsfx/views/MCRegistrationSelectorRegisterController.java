 ...
 * @author user
 */
public class MCRegistrationSelectorRegisterController implements Initializable {
    ...
    private void Table_Click(MouseEvent event) {
        ...
        if (poTrans.getSysFile(pnRowTable, "sFileCode").equals("")) return;
            if (event.getClickCount() == 2){              
                ...
                try {
                    loMultipleDocs.setFileCode(String.valueOf(poTrans.getDetail(pnRowTable, "sFileCode").toString()));
                    loMultipleDocs.setBarcode(String.valueOf(poTrans.getDetail(pnRowTable, "sBarrcode")));
                    loMultipleDocs.setB2BPage(String.valueOf(poTrans.getDetail(pnRowTable, "sB2BPagex").toString()));
                    loMultipleDocs.setNoOfPage((int) poTrans.getDetail(pnRowTable, "nNoPagesx"));
    ...
    private void loadCRScanner(){
        ...
        MCRegistrationController loController = new MCRegistrationController();
        FXMLLoader fxmlLoader = new FXMLLoader();
        fxmlLoader.setLocation(getClass().getResource("MCRegistration.fxml"));
        ...
        loController.setLoaded(getLoadedIsRegister());
        loController.setMultipleDocsReg(this);
        ...
        try {
            ...
            if (pnEditMode != EditMode.ADDNEW){
                ...
                loController.setBranchName(psBranchNm);
    ...
    public boolean getLoadedIsRegister(){
        return isRegister;
    }
...
//    }
    ...
    private void loadTransaction(){
        ...
        psBranchNm =(String) poTrans.getOrigin().getMaster("sBranchNm");
        loadDetail2Grid();
    ...
    lblPageNo.setText(String.valueOf(fnSize));
    table.requestFocus();
