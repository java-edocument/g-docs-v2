...
public class MCRegistrationSelectorController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
         if (poGRider == null){
            ...
            try {
                ...
                Logger.getLogger(MCRegistrationSelectorController.class.getName()).log(Level.SEVERE, null, ex);
            }
