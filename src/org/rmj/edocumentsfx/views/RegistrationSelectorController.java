 ...
 * @author user
 */
public class RegistrationSelectorController implements Initializable {
    ...
    @FXML private TableView<TableModel> table1;
...
//                break;
    ...
    private void loadCRScanner(){
        RegistrationWithMultipleSelectionController loController = new RegistrationWithMultipleSelectionController();
        FXMLLoader fxmlLoader = new FXMLLoader();
        fxmlLoader.setLocation(getClass().getResource("RegistrationWithMultipleSelection.fxml"));
        ...
        try {
            ...
            Logger.getLogger(RegistrationSelectorController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
